      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            <div className="text-sm text-blue-200 font-semibold mb-4">Tutorial</div>
      ...
      <section className="section-padding bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Essential Python Libraries for Data Science</h2>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Setting Up Your Data Science Environment</h2>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Your First Data Science Project</h2>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Best Practices for Python Data Science</h2>
